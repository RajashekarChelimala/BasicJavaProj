...
class Account{
	...
	public Account(double balance, PersonD accHolder) {
		super();
	...
	public PersonD getAccHolder() {
		return accHolder;
	}
	public void setAccHolder(PersonD accHolder) {
		this.accHolder = accHolder;
	}
...
class SavingsAccount extends Account{
	...
	public SavingsAccount(double balance, PersonD accHolder) {
...
class CurrentAccount extends Account{
	...
	public CurrentAccount(double balance, PersonD accHolder) {
		super(balance, accHolder);
		// TODO Auto-generated constructor stub
	}
...
public class TwoOne {
	...
	try {
		...
		PersonD p3 = new PersonD();
		p3.setName("Divya");
		PersonD p4 = new PersonD();
		p4.setName("john");
